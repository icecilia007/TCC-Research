...
A pesquisa foca na hipersensibilidade visual subjetiva, um fenômeno de desconforto a estímulos visuais que é comumente relatado em diversas condições clínicas e áreas de *neurodiversidade* (e.g., enxaqueca, autismo). O estudo busca resolver o problema da falta de clareza sobre se há um único tipo de hipersensibilidade ou subtipos dissociáveis, o que impede o avanço no entendimento de seus mecanismos neurais. A metodologia foi conduzida em duas fases principais, iniciando pela elaboração e refinamento dos itens do questionário: foram gerados 26 itens iniciais a partir de questionários existentes, literatura sobre gatilhos e um grande *dataset* qualitativo de 765 participantes, com ajustes iterativos baseados em *feedback* para focar em mudanças funcionais (evitação). Subsequentemente, a estrutura fatorial foi replicada em cinco coortes (totalizando mais de 3500 participantes) usando análises fatoriais exploratórias e confirmatórias. Os resultados confirmaram consistentemente uma estrutura de quatro fatores replicáveis: *Brightness* (Brilho), *Pattern* (Padrão), *Strobing* (Estroboscópio) e *Intense Visual Environments* (Ambientes Visuais Intensos). O trabalho resultou na escala *Cardiff Hypersensitivity Scale* (*CHYPS*), um instrumento de 20 itens (5 por fator), que demonstrou excelente confiabilidade ($\alpha$ e $\omega$ superiores a 0.84) e forte validade convergente com outras escalas de sensibilidade visual ($r$ superior a 0.69). Este achado suporta a ideia de que a hipersensibilidade visual possui um fator geral unificado, mas manifesta-se em quatro dimensões específicas, oferecendo um avanço prático e teórico para pesquisas futuras.
