...
**Artigo 1:** On Evaluating the Efficiency of Source Code Generated by LLMs (Artigos/On Evaluating the Efficiency of Source Code Generated by LLMs.pdf) (Lista Base) 
   [Fichamento Artigo 1](./LISTA-BASE-78_fichamento-niu-LLMs.md)

**Artigo 2:** Navigating the Complexity of Generative AI Adoption in Software Engineering (Lista Base) 
   [Fichamento Artigo 2](./LISTA-BASE-76_fichamento-navigating-the-complexity-of-generativ.md)

**Artigo 3:** Evaluation of electroretinography (ERG) parameters as a biomarker for ADHD 
   [Fichamento Artigo 3](./fichamento-erg-ADHD.md)

**Artigo 4:** ERG Classification by Using ML Methods Based on Short-Time Fourier Transform
   [Fichamento Artigo 4](./fichamento-albasu-erg.md)

**Artigo 5:** Understanding the subtypes of visual hypersensitivity: Four coherent factors and their measurement with the Cardiff Hypersensitivity Scale (CHYPS)
   [Fichamento Artigo 5](./fichamento-hypersensitivity.md)

**Artigo 6:** Semantic Textual Similarity Analysis of Clinical Text in the Era of LLM
