...
* *Runtime* (Tempo de Execução) é avaliado em *gem5 Central Processing Unit simulator* para HumanEval e MBPP e por métricas de porcentagem de usuários superados em LeetCode, repetido múltiplas vezes para reduzir ruído (páginas 104–105).
